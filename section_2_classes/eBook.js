 ...
 * Ebook Exercise
    ...
    number and a method download() that returns a string with the title of the ebook and its fileSize.
 */
...
const myBook = new Book('first', 'me', 13)
const ebook = new Ebook('second', 'him', 11, 15)
